...
var Logger = class {
  ...
  #addDuration(message, duration) {
    ...
    return `${message} ${this.getColors().dim(`(${prettyHrtime2(process.hrtime(duration))})`)}`;
  }
  /**
...
// src/tasks/task.ts
import prettyHrtime3 from "pretty-hrtime";
var Task = class {
  constructor(title) {
    this.title = title;
  }
  ...
  markAsSucceeded(message) {
    ...
    this.#duration = prettyHrtime3(process.hrtime(this.#startTime));
